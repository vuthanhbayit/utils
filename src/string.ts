...
/**
 * Truncate text, doesn't cut words
 * @param input: string
 * @param length: number
 ...
 * @example truncateText(text, 20) // return Apple thành công ...
 * @example truncateText(text, 17) // return Apple thành công ...
 */
export const truncateText = (
  ...
  // lấy index khoảng trắng cuối cùng trong khoảng limit
